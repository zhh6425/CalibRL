...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(
        ...
        if role == "actor" and optim_config is not None:
            from src.torch_functional import (
            ...
            decay_every_step = optim_config.get("decay_every_step", 100)
            decay_gamma = optim_config.get("decay_gamma", 0.1)
            ...
            if warmup_style == "constant":
                ...
                actor_lr_scheduler = get_step_schedule_with_warmup(optimizer=actor_optimizer, num_warmup_steps=num_warmup_steps, step_size=decay_every_step, gamma=decay_gamma)
            else:
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == "hf":
            ...
            from src.vllm_rollout_spmd import vllm_mode, vLLMRollout # vllm_rollout_spmd
    ...
    def init_model(self):
        from src.dp_actor import DataParallelPPOActor
