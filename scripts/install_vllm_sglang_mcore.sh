...
#     NVTE_FRAMEWORK=pytorch pip3 install --no-deps git+ssh://git@github.com/NVIDIA/TransformerEngine.git@v2.2
#     # pip3 install --no-deps git+ssh://git@github.com/NVIDIA/Megatron-LM.git@core_v0.12.0rc3
# fi
# if [ $USE_MEGATRON -eq 1 ]; then
#     echo "4. install TransformerEngine and Megatron (via SSH)"

#     # —— 让 Git 全局把 https://github.com/xxx 替换成 git@github.com:xxx —— #
#     git config --global url."git@github.com:".insteadOf "https://github.com/"

#     echo "Notice that TransformerEngine installation can take very long time, please be patient"
#     NVTE_FRAMEWORK=pytorch \
#       pip3 install --no-deps \
#         git+ssh://git@github.com/NVIDIA/TransformerEngine.git@v2.2

#     # pip3 install --no-deps \
#     #     git+ssh://git@github.com/NVIDIA/Megatron-LM.git@core_v0.12.0rc3

#     # （可选）如果你不想保留这条全局配置，安装完之后再删除它：
